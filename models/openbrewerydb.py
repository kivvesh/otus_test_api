...
class Brewery(BaseModel):
    ...
    address_1: Optional[str] = Field(..., description="Primary address of the brewery")
    ...
    longitude: Optional[str] = Field(..., description="Longitude coordinate of the brewery")
    latitude: Optional[str] = Field(..., description="Latitude coordinate of the brewery")
    phone: Optional[str] = Field(..., description="Contact phone number for the brewery")
    website_url: Optional[HttpUrl] = Field(..., description="Website URL of the brewery")
    state: Optional[str] = Field(..., description="State where the brewery is located")
    street: Optional[str] = Field(..., description="Street address of the brewery")
